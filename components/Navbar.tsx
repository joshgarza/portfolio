...
// return (
//   <header
//     className={`w-full mx-auto px-4 bg-gray-50 shadow fixed top-0 z-50 sm:px-20 ${
//       currentTheme === "dark" && "bg-stone-900 border-b border-stone-600"
//     }`}
//   >
//     <div className="justify-between md:items-center md:flex">
//       <div>
...
//                   to={item.page}
//                   className={
//                     "block lg:inline-block text-neutral-900 hover:text-neutral-500 dark:text-neutral-50"
//                   }
//                   activeClass="active"
//                   spy={true}
//                   smooth={true}
